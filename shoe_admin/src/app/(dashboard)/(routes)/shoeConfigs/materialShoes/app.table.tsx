...
export default function MaterialShoesTable() {
    ...
    const getData = async () => {
        const res = await shoeConfigAPI.getMaterialsConfig();
        console.log(res)
        if (res) {
            setData(res);
        }
    ...
    const handleAddDataConfig = async () => {
        try {
            ...
            await shoeConfigAPI.addShoesMaterial(newData);
        ...
        <div>
                    ...
                    {currentItems.map((data, index) => (
                        <TableRow key={index}>
                            ...
                            <TableCell className="text-right">
                                ...
                                {/* End edit */}
                                {/* Button delete */}
                                <Button variant="destructive" onClick={() => handleDeleteData(data.id)}>
            ...
            <div className="flex justify-center mt-4">
                <ul className="flex space-x-2">
                    {Array.from({ length: Math.ceil(dataAPI.length / itemsPerPage) }, (_, i) => (
                        <li key={i}>
                            <button

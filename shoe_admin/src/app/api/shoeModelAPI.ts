...
class ShoeModelAPI {
    urlConfig = `/shoes-store/v1/admin/shoes/list`;
    url = `/shoes-store/v1/admin/shoes`;
    getModel = async (models: any) => {
        try {
...
const shoeModelAPI = new ShoeModelAPI();
export default shoeModelAPI;
